...
model.load_state_dict(torch.load('/home/sun/Endometrial/ICMIL/utils/ResNet50_DTFD_axgated_teacher_student_best1024_BETA2.pth')) # you can also use the default ImageNet pretrained weights by commenting this line

# model=torch.nn.DataParallel(model)
model.eval()
filenames=sorted(glob.glob('/mnt/gemlab_data/User_database/zhushiwei/CAMELYON16/extracted_patches/testing/0.0/*'))
for cases in filenames:
    ...
    np.save(cases+'/resnet1024_feats2.npy',feats)

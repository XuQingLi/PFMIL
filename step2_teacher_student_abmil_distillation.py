...
model_teacher.load_state_dict(torch.load('/home/gem/zsw/MixTrain/2025-01-13_04:59:49/trained_feature_network_model_epoch_191.pth','cpu'))
for param in model_teacher.parameters():
    param.requires_grad = False
model_teacher.eval()

model_student=resnet50_baseline(True).to(device)
model_student.load_state_dict(torch.load('/home/gem/zsw/MixTrain/2025-01-13_04:59:49/trained_feature_network_model_epoch_191.pth','cpu'))
...
checkpoint=torch.load('/home/sun/Endometrial/CLAM/checkpoints/conch/pytorch_model_coach.bin',map_location='cpu')
...
trainset=RandomPatchDistillationDataset('/mnt/gemlab_data/User_database/zhushiwei/CAMELYON16/result/training',mode='train',level=1)
valset=RandomPatchDistillationDataset('/mnt/gemlab_data/User_database/zhushiwei/CAMELYON16/test',mode='val',level=1)

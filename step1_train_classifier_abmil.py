...
trainset=Camelyon('/mnt/gemlab_data/User_database/zhushiwei/CAMELYON16/result/training',mode='train',level=1)
testset=EmbededFeatsDataset('/mnt/gemlab_data/User_database/zhushiwei/CAMELYON16/test',mode='test',level=1)
...
for ii in range(params.EPOCH):
    ...
    print('testing...')
    auc,acc,f1=TestModel(testloader)
    if auc>best_auc:
        best_auc=auc
        tsave_dict = {
